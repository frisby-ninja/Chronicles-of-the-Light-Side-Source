...
public class OresConfig {
    ...
    public static ForgeConfigSpec.IntValue INTERNET_VEINSIZE;
    public static ForgeConfigSpec.IntValue INTERNET_AMOUNT;
    ...
    public static void registerCommonConfig(ForgeConfigSpec.Builder COMMON_BUILDER) {
        ...
        INTERNET_VEINSIZE = COMMON_BUILDER
                .comment("Veinsize of our ore in the internet dimension")
                .defineInRange("internetVeinsize", 25, 1, Integer.MAX_VALUE);
        INTERNET_AMOUNT = COMMON_BUILDER
                .comment("Amount of veines of our ore in the internet dimension")
                .defineInRange("internetAmount", 10, 1, Integer.MAX_VALUE);
