package net.ninjaworks.chroniclesofthelightside.manasystem.network;
...
import net.ninjaworks.chroniclesofthelightside.manasystem.data.ManaManager;
import net.ninjaworks.chroniclesofthelightside.manasystem.data.PlayerManaProvider;
